package com.functionapps.files;
...
//			oldFile.delete();
    ...
    public void moveCDRFile(Connection conn, String fileName, String opertorName, String fileFolderPath, String source, String errortype) {

        File folder = null;
        String storagePath = new com.functionapps.parser.HexFileReader().getFilePath(conn, "CdrProcessedFileStoragePath");  //  with /
