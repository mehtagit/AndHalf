...
public class CEIRFeatureFileParser {
    ...
    private static void addCDRInProfileWithRule(String operator, Connection conn, ArrayList<Rule> rulelist,
        ...
        try {
            ...
            // query = "select * from "+operator+"_raw where sno>"+old_sno+" and
            // status='Init' order by sno asc FETCH FIRST "+parser_base_limit+" ROWS WITH
            // TIES ";
...
//					stmt2.executeBatch();
    ...
    private static HashMap<String, String> getStolenRecvryDetails(Connection conn, String txn_id) {
    ...
    private static ArrayList getRuleDetails(String operator, Connection conn, String operator_tag, String period,            String feature, String usertype_name) {
        ...
        try {
            query = "select a.id as rule_id,a.name as rule_name,b.output as output,b.grace_action, b.post_grace_action, b.failed_rule_action_grace, b.failed_rule_action_post_grace from rule_engine a, rule_engine_mapping b where  a.name=b.name  and a.state='FULL' and b.feature='"
                    + operator + "' and b.user_type='" + usertype_name + "' order by b.rule_order asc";
    ...
    static int imeiCountfromRawTable(Connection conn, String txn_id, String operator) {
        int rsslt = 0;
        String query = null;
        Statement stmt = null;
