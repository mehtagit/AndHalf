...
//         
        try { 
            ...
            {
                ResultSet result1 = stmt2.executeQuery("select count(imei_esn_meid) from device_manufacturer_db  where imei_esn_meid='" + args[3] + "' ");
                String res2 = "0";
                try {
                    while (result1.next()) {
...
////                if (rowsInserted1 > 0) {
////                    logger.info("inserted into device_manufacturer_db ");
////                }
////  
////            } else 
//            {
