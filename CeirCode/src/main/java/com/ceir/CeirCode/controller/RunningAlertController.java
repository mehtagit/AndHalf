...
public class RunningAlertController {
	...
	public MappingJacksonValue viewRecord(@RequestBody RunningAlertFilter filterRequest,
		...
		if( file == 0) {
			Page<RunningAlertDb> alertResponse  = runAlertService.viewRunningAlertData(filterRequest, pageNo, pageSize);
			...
			FileDetails fileDetails = runAlertService.getRunningAlertInFile(filterRequest);
