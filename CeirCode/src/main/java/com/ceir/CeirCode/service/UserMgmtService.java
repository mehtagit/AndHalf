...
public class UserMgmtService {
	...
	private GenericSpecificationBuilder<User> buildSpecification(UserMgmtFilter filterRequest){
		...
		if(Objects.nonNull(filterRequest.getSearchString()) && !filterRequest.getSearchString().isEmpty()){
			...
			uPSB.orSearch(new SearchCriteria("userProfile-email",filterRequest.getSearchString(),SearchOperation.LIKE, Datatype.STRING));
			uPSB.orSearch(new SearchCriteria("userProfile-phoneNo",filterRequest.getSearchString(),SearchOperation.LIKE, Datatype.STRING));
