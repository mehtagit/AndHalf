...
public class EmailService implements Runnable {
	...
	public void run() {
		SystemConfigurationDb batchSizeData = systemConfigRepoImpl.getDataByTag("Reporting_Authority_Notification");
		...
		MessageConfigurationDb messageDb = messageRepo.getByTag("Total_email_Send_InSec");
