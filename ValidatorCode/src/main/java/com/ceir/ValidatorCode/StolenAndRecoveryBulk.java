...
public class StolenAndRecoveryBulk {
	...
	public String incidentPropertyLocation;
	public String incidentStreet;
	public String incidentVillage;
	public String incidentLocality;
	public String incidentDistrict;
	public String incidentCommune;
	public Integer incidentPostalCode;
	...
	public String toString() {
		...
		stringBuilder.append("StolenAndRecoveryBulk [companyName=");
		...
		stringBuilder.append(country);
		stringBuilder.append(", incidentPropertyLocation=");
		stringBuilder.append(incidentPropertyLocation);
		stringBuilder.append(", incidentStreet=");
		stringBuilder.append(incidentStreet);
		stringBuilder.append(", incidentVillage=");
		stringBuilder.append(incidentVillage);
		stringBuilder.append(", incidentLocality=");
		stringBuilder.append(incidentLocality);
		stringBuilder.append(", incidentDistrict=");
		stringBuilder.append(incidentDistrict);
		stringBuilder.append(", incidentCommune=");
		stringBuilder.append(incidentCommune);
		stringBuilder.append(", incidentPostalCode=");
		stringBuilder.append(incidentPostalCode);
		stringBuilder.append(", incidentProvince=");
		stringBuilder.append(incidentProvince);
		stringBuilder.append(", incidentCountry=");
		stringBuilder.append(incidentCountry);
		...
		stringBuilder.append(remark);
		stringBuilder.append(", personnelFirstName=");
		stringBuilder.append(personnelFirstName);
		stringBuilder.append(", personnelMiddleName=");
		stringBuilder.append(personnelMiddleName);
		stringBuilder.append(", personnelLastName=");
		stringBuilder.append(personnelLastName);
