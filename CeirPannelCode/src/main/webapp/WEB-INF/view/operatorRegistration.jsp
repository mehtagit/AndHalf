						...
						<div class="row">
							...
							<div class="row">
								...
								<div class="input-field col s12 m6 l6">
									...
									oninput="InvalidMsg(this,'input','<spring:message code="validation.30Characters" />');" oninvalid="InvalidMsg(this,'input','<spring:message code="validation.30Characters" />');" title="" >
