...
<script type="text/javascript"
	src="${context}/resources/graph_js/chart.min.js"></script>
						...
						<div class="col s12 m12 l12">
							<div class="row card-panel">
								<div class="row card-panel responsive-page"
									id="endUserRaiseGrievance" style="display: block !important">
											...
											<div class="col-xl-8 col-lg-7">
												<div class="card shadow mb-4">
													...
													<div
														...
														<h6 class="m-0 font-weight-bold text-primary">Operator
															Wise IMEIs</h6>
														<div>
                ...
                <div class="card-body">
                    ...
                    <canvas class="chart-area" id="horizontalBarGraph" style = "width: 550px; height: 400px; margin: 0 auto">
												...
												<div class="card shadow mb-4">
													...
													<!-- Card Body -->
													<div class="card-body">
														<canvas class="chart-area" id="lineGraph"
