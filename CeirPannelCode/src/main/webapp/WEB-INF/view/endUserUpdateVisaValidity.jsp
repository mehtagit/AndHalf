                ...
                <div class="container">
                    <div class="section">
                        <div class="row card-panel update-visa-responsive-page" style="width:50%; margin:auto;margin-bottom: 50px;margin-top: 20px;">
                           <h6 class="fixPage-modal-header "><spring:message code="input.UpdateVisaValidity" /></h6>
                                    ...
                                    <div class="row">
                                      <div class="row">
                                            ...
                                            <div id="submitbtn">
                                             <div class="input-field col s12 m1 l1">
                                                ...
                                                <div class="input-field col s12 m3 l3">
                                                    <input type="text" id="nidForEndUser"  pattern="[A-Za-z0-9]{0,15}" 
										oninput="InvalidMsg(this,'input');" oninvalid="InvalidMsg(this,'input');"
												 title= "<spring:message code="validation.maximum18" />" required / maxlength="15" name="Search"  />
                                        ...
                                        <div id="EndUserInfoForm" style="display: none;">
                                              <form id="" onsubmit="return updateVisaDetails()" method="POST" enctype="multipart/form-data" >
                                            <div class="row">
                                                <div class="input-field col s12 m6">
                                                    <input type="text" id="endUserpassportNumber" name="endUserpassportNumber"  placeholder=""
                                                        pattern="[a-zA-Z0-9]{1,15}" 
													oninput="InvalidMsg(this,'input');" oninvalid="InvalidMsg(this,'input');"
												 title= "<spring:message code="validation.15numbers" />" required  /  maxlength="15" />
							...
							oninput="InvalidMsg(this,'input');" oninvalid="InvalidMsg(this,'input');"  required / id="uploadPassportID">
                                                    </div>
                                                    <div class="file-path-wrapper" id="passportFileNameDiv">
                                                        <input class="file-path validate" type="text" id="passportFileName" placeholder="" value="">
                                                    </div>
                                                </div>
									...
									oninput="InvalidMsg(this,'input');" oninvalid="InvalidMsg(this,'input');"
                                                ...
                                                <div class="input-field col s12 m6 l6">
                                                    <input type="text" required="required" placeholder=""
                                                       pattern="[^[a-zA-Z0-9\s,'-]*$]{0,50}"   class="form-control boxBorder boxHeight" id="endUserstreetNumber"
												oninput="InvalidMsg(this,'input');" oninvalid="InvalidMsg(this,'input');"
												 title= "<spring:message code="validation.50character" />" required  /  maxlength="50">
                                                    <label for="streetNumber"><spring:message code="input.streetNumber" /> <span
                                                            class="star">*</span></label></div>
                                                <div class="input-field col s12 m6 l6">
                                                    <input type="text" placeholder="" placeholder=""  pattern="[^[a-zA-Z0-9\s,'-]*$]{0,50}" 
												oninput="InvalidMsg(this,'input');" oninvalid="InvalidMsg(this,'input');"
												 title= "<spring:message code="validation.50character" />" required  /
                                                        class="form-control boxBorder boxHeight" id="endUserlocality"  maxlength="20" >
                                                    <label for="locality"><spring:message code="input.locality" /> <span class="star">*</span></label>
                                                </div>

                                                <div class="input-field col s12 m6 l6">
                                                    <input type="text"  placeholder="" id="endUservillage" pattern="[^[a-zA-Z0-9\s,'-]*$]{0,50}" 
												oninput="InvalidMsg(this,'input');" oninvalid="InvalidMsg(this,'input');"
												 title= "<spring:message code="validation.50character" />" required  / maxlength="20" >
										...
										oninput="InvalidMsg(this,'input');" oninvalid="InvalidMsg(this,'input');"
												 title= "<spring:message code="validation.50character" />" required  /   id="endUsercommune" maxlength="50">
											...
											oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('<spring:message code="validation.requiredMsg" />')"
                                                ...
                                                <div class="input-field col s12 m6 l6">
                                                    <p style="margin-top: -15px; margin-bottom: -3px; font-size: 12px;"><spring:message code="input.Country" />
										...
										oninput="InvalidMsg(this,'input');" oninvalid="InvalidMsg(this,'input');" style="padding-left: 0;" required></select>
                                                </div>
								...
								title="<spring:message code="validation.selectFieldMsg" />" oninput="setCustomValidity('')"  
								oninput="InvalidMsg(this,'select');" oninvalid="InvalidMsg(this,'select');" style="padding-left: 0;" required / ></select> </div>
                                                ...
                                                <div class="input-field col s12 m6" style="    margin-top: 0;">
                                                    ...
                                                    <input type="tel" 
oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('<spring:message code="validation.requiredMsg" />')"
												 title= "<spring:message code="validation.requiredMsg" />" required  / placeholder=""  id="phone" maxlength="15">
                                                </div>

                                                <div class="input-field col s12 m6">
                                                    <input type="email" id="endUseremailID" placeholder="" 
     												 title="<spring:message code="validation.Matchformat" />"                                                  
   													 oninput="InvalidMsg(this,'email');" oninvalid="InvalidMsg(this,'email');" required  / maxlength="30" />
                                            ...
                                            <div class="row">
												...
												title="<spring:message code="validation.selectFieldMsg" />" oninput="setCustomValidity('')"  
										oninput="InvalidMsg(this,'select');" oninvalid="InvalidMsg(this,'select');" style="padding: 0; height: 35px;">
                ...
                onchange="InvalidMsg(this,'date');" oninvalid="InvalidMsg(this,'date');"                                        
                                                  title="<spring:message code="validation.date" />" required / maxlength="15" />
                                                ...
                                                <div class="file-field col s12 m6" style="margin-top: -8px;">
                                                    ...
                                                    <div class="btn">
                                                        ...
                                                        <input type="file" 
   												 title="<spring:message code="validation.NoChosen" />" 
	oninput="InvalidMsg(this,'fileType');" oninvalid="InvalidMsg(this,'fileType');"  oninput="setCustomValidity('')"  required /  id="endUseruploadnationalID" 
