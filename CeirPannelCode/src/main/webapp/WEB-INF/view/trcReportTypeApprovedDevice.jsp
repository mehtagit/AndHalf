							...
							<form>
								<div class="row" style="margin-top: 10px;">
									...
									<div class="input-field col s12 m6">
										<input type="text" id="requestDate" class="form-control datepick"
											name="requestDate" pattern="[]" title="" autocomplete="off">
								...
								<div class="row">
									<div class="input-field col s12 m6">
										<input type="text" id="approveDisapproveDate"
											class="form-control datepick" name="approveRejectionDate" pattern="[]"
											title="" autocomplete="off" /> <span class="input-group-addon"
