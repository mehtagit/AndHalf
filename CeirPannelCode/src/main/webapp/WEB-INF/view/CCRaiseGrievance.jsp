...
<div id="fileFormateModal" class="modal">
 ...
 <!-- jQuery Library -->
    ...
    <!--prism
    <script type="text/javascript" src="${context}/resources/js/prism/prism.js?version=<%= (int) (Math.random() * 10) %>"></script>-->
    <!--scrollbar-->
    ...
    <!-- chartist -->
    <script type="text/javascript" src="${context}/resources/js/plugins/chartist-js/chartist.min.js?version=<%= (int) (Math.random() * 10) %>"></script>
<!-- i18n library -->
