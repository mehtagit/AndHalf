...
<head>
   ...
   <!-- jQuery Library -->
    ...
    <link href="${context}/resourcesCss/js/plugins/data-tables/css/jquery.dataTables.min.css" type="text/css" rel="stylesheet"
        media="screen,projection">

    <!-- Favicons-->
    <!--<link rel="icon" href="images/favicon/favicon-32x32.png" sizes="32x32">-->
    <!-- Favicons-->
    <link rel="apple-touch-icon-precomposed" href="${context}/resourcesCss/images/favicon/apple-touch-icon-152x152.png">
    <!-- For iPhone -->
    <meta name="msapplication-TileColor" content="#00bcd4">
    <meta name="msapplication-TileImage" content="${context}/resourcesCss/images/favicon/mstile-144x144.png">
    <!-- For Windows Phone -->
    <link rel="stylesheet" href="${context}/resourcesCss/font/font-awesome/css/font-awesome.min.css">
    ...
    <link href="${context}/resourcesCss/js/plugins/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet"
        media="screen,projection">
...
style="font-size: 20px; color: red;" title="delete"></i></a>
 ...
 --%>
    ...
    <script type="text/javascript" src="${context}/resourcesCss/js/plugins/data-tables/data-tables-script.js"></script>
