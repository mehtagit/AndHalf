            ...
            <div class="section">
                <form id="registrationForm">
                    <div class="card-panel" style="width: 90%; margin: auto; padding: 20px 5% 20px 5%;">
                        <!-- <a href="index.html" style="float: right; margin: -10px; margin-right: -20px;"><i
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    <p style="margin-top: -15px; margin-bottom: -3px; font-size: 12px;">AsType <span
                                            class="star">*</span></p>
                                    <select class="browser-default" id="mySelect" onchange="myFunction()" required>
                                ...
                                <div class="input-field col s12 m6 l6" id="passportNumberDiv" style="display: none;">
                                    <input type="text" name="passportNumber" class="form-control boxBorder boxHeight"
                                        id="passportNumber" maxlength="20">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    <input type="text" name="phone" class="form-control boxBorder boxHeight" id="phone"
                                        maxlength="10">
                                ...
                                <div class="input-field col s12 m12 l12">
                                    <input type="text" name="address" class="form-control boxBorder boxHeight"
                                        id="address">
                                    <label for="address">Address(Property Location) <span class="star">*</span></label>
                                </div>

                                <div class="input-field col s12 m6 l6">
                                    <input type="text" name="streetNumber" class="form-control boxBorder boxHeight"
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    ...
                                    <select multiple required>
                                        <option value="" disabled selected>Role Type <span class="star"></span></option>
                            ...
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    <input type="text" name="SecurityAnswer" class="form-control boxBorder boxHeight"
                                        id="SecurityAnswer" maxlength="50">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 center">
                                <a href="verifyOTP.html" class="btn" id="btnSave"> Submit</a>
