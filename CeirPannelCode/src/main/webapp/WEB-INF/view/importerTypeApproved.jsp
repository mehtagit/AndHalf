...
<div class="row" >
 ...
 <label for="trademark"><spring:message code="registration.trademark" /> <span class="star">*</span></label>
</div>


  <div class="col s12 m6 l6" style="margin-bottom: 5px;">
 <label for="productName"><spring:message code="registration.productname" /> <span class="star">*</span></label>
 ...
 <div class="row">
                                            <div class="col s12 m6 l6">
                                                <label for="modalNumber"><spring:message code="registration.modelnumber" /> <span class="star">*</span></label>
                                             ...
                                             <div class="col s12 m6 l6">
                                                <label><spring:message code="registration.countrymanufacture" />
...
<div class="row" style="margin-top: 10px;">
                                                ...
                                                <input type="text" id="Remark" class="materialize-textarea" maxlength="50">
                                                <label for="Remark"><spring:message code="registration.frequencyrange" /> <span class="star">*</span></label>
                                            </div>
                                            <div class="input-field col s12 m6 l6">
                                                <input type="text" id="tac"  name="tac" maxlength="8">
                                                <label for="tac"><spring:message code="registration.tac" /> <span class="star">*</span></label>
                                            </div>
   </div>
