            ...
            _createClass(Iti, [ {
                ...
                value: function _appendListItems(countries, className) {
                    ...
                    for (var i = 0; i < countries.length; i++) {
                        ...
                        // close the list item
                        tmp += "</li>";
                        //document.getElementById("phone").value=c.dialCode;
                    }
                ...
                value: function _bindDropdownListeners() {
                    ...
                    this._handleKeydownOnDropdown = function(e) {
                        ...
                        if (e.key === "ArrowUp" || e.key === "Up" || e.key === "ArrowDown" || e.key === "Down") _this9._handleUpDownKey(e.key); else if (e.key === "Enter") _this9._handleEnterKey(); else if (e.key === "Escape") _this9._closeDropdown(); else if (/^[a-zA-ZÃ€-Ã¿ ]$/.test(e.key)) {
