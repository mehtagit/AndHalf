		...
		success: function(data){
			...
			for(i=0; i<date.length; i++){
				if(date[i].type === "date"){
					...
					$("#consignmentTableDIv").append("<div class='input-field col s6 m2 filterfield' style='margin-top: 22px;'><input type="+date[i].type+" id="+date[i].id+" maxlength='18' /><label for='TransactionID' class='center-align'>"+date[i].title+"</label></div>");
				}
			} 
