			...
			$.ajax({
				...
				success: function(result){
					...
					$('div#initialloader').delay(300).fadeOut('slow');
						$('#userManagementLibraryTable input').unbind();
						$('#userManagementLibraryTable input').bind('keyup', function (e) {
							if (e.keyCode == 13) {
			...
			$.ajax({
				...
				// dynamic dropdown portion
					...
					for(i=0; i<dropdown.length; i++){
						...
						//$("#userManagementTableDiv").append("<div class=' col s3 m2 l7'><a href='JavaScript:void(0)' type='button' class='export-to-excel right'  onclick='exportConsignmentData()'>"+$.i18n('Export')+"<i class='fa fa-file-excel-o' aria-hidden='true'></i></a></div>");
