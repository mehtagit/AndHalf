	...
	var lang=window.parent.$('#langlist').val() == 'km' ? 'km' : 'en';
		...
		$.i18n().locale = lang;
		var exportButton,documenttype,selectfile,selectDocumentType;
		$.i18n().load( {
			'en': './resources/i18n/en.json',
			'km': './resources/i18n/km.json'
		} ).done( function() { 
				exportButton=$.i18n('button.export');
	...
	function pageRendering(){
		$.ajax({
			...
			success: function(data){
				...
				$("#greivanceTableDiv").append("<div class='col s12 m1'><a href='JavaScript:void(0)' type='button' class='export-to-excel right'  onclick='exportData()'>"+exportButton+"<i class='fa fa-file-excel-o' aria-hidden='true'></i></a></div>");
