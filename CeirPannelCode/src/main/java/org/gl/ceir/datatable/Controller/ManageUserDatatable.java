...
public class ManageUserDatatable {
	...
	public ResponseEntity<?> viewManageUser(
			@RequestParam(name = "type", defaultValue = "manageUser", required = false) String role,
	...
	public ResponseEntity<?> directives(
		...
		String[] names = { "HeaderButton", Translator.toLocale("table.registerUser"), "./immigration_register",
				"btnLink", "FilterButton", Translator.toLocale("button.filter"),
				"filter(" + ConfigParameters.languageParam + ")", "submitFilter" };
		...
		String[] dateParam = { "date", Translator.toLocale("input.startDate"), "startDate", "", "date",
				...
				"transactionID", "", "text", Translator.toLocale("input.passportNo"), "nId", "" };
