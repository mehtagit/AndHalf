...
public class PortDatatableController {
	...
	public ResponseEntity<?> viewPortRecord(
			@RequestParam(name = "type", defaultValue = "portAddress", required = false) String role,
	...
	public ResponseEntity<?> pageRendering(
			@RequestParam(name = "type", defaultValue = "portManagement", required = false) String role,
			HttpSession session) {
