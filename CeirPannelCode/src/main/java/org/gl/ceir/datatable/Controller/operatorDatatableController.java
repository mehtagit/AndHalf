...
public class operatorDatatableController {
	...
	public ResponseEntity<?> viewOperatorRecord(
			@RequestParam(name = "type", defaultValue = "Operator", required = false) String role,
	...
	public ResponseEntity<?> pageRendering(
		...
		String[] names = { "FilterButton", Translator.toLocale("button.filter"),
				"operatorDatatable(" + ConfigParameters.languageParam + ")", "submitFilter" };
