...
public class UserFeatureDatatable {
	...
	public ResponseEntity<?> viewuserFeatureMapping(
			@RequestParam(name = "type", defaultValue = "userFeatureMapping", required = false) String role,
	...
	public ResponseEntity<?> pageRendering(
		...
		String[] names = { "HeaderButton", Translator.toLocale("button.addCurrency"), "AddCurrencyAddress()", "btnLink",
				...
				"viewDatatable(" + ConfigParameters.languageParam + ")", "submitFilter" };
		...
		// Dropdown items
		String[] selectParam = { "select", "Select UserType", "userType", "", "select", "Select Feature", "feature", "",
