...
public class UserManagementDatatable {
	...
	public ResponseEntity<?> viewuserManagement(
			@RequestParam(name = "type", defaultValue = "userManagement", required = false) String role,
	...
	public ResponseEntity<?> pageRendering(
		...
		String[] names = { "HeaderButton", Translator.toLocale("button.addCurrency"), "AddCurrencyAddress()", "btnLink",
				...
				"userManangementTable(" + ConfigParameters.languageParam + ")", "submitFilter" };
		...
		// Dropdown items
		String[] selectParam = { "select", Translator.toLocale("select.userType"), "userType", "" };
