...
public class ConsignmentService {
	...
	public String registerConsignmnet(ConsignmentModel consignmentModel, MultipartFile file) {
		...
		// request validate
		if (!consignmentModel.getSupplierId().equals("") && !consignmentModel.getSupplierName().equals("")
				&& !consignmentModel.getConsignmentNumber().equals("")
				&& !consignmentModel.getExpectedArrivalDate().equals("")
				&& !consignmentModel.getExpectedDispatcheDate().equals("") && !consignmentModel.getQuantity().equals("")
				&& consignmentModel.getExpectedArrivalPort() != null
				&& consignmentModel.getOrganisationcountry() != null && !file.getOriginalFilename().equals("")) {
			// Process
	...
	public String updateConsignmnet(ConsignmentModel consignmentModel, MultipartFile file, String txnid) {
		...
		if (!consignmentModel.getSupplierId().equals("") && !consignmentModel.getSupplierName().equals("")
				...
				&& !consignmentModel.getExpectedDispatcheDate().equals("") && !consignmentModel.getQuantity().equals("")
				&& consignmentModel.getExpectedArrivalPort() != null
				&& consignmentModel.getOrganisationcountry() != null && txnid != "") {
			// Process
			log.info("Request is valid.");
