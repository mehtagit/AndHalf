...
public class StolenOrganizationUserDB {
	...
	public String toString() {
		return "StolenOrganizationUserDB [commune=" + commune + ", companyName=" + companyName + ", country=" + country
				+ ", createdOn=" + createdOn + ", district=" + district + ", email=" + email + ", id=" + id
				+ ", incidentCommune=" + incidentCommune + ", incidentCountry=" + incidentCountry
				+ ", incidentDistrict=" + incidentDistrict + ", incidentLocality=" + incidentLocality
				+ ", incidentPostalCode=" + incidentPostalCode + ", incidentProvince=" + incidentProvince
				+ ", incidentStreet=" + incidentStreet + ", incidentVillage=" + incidentVillage + ", locality="
				+ locality + ", modifiedOn=" + modifiedOn + ", personnelFirstName=" + personnelFirstName
