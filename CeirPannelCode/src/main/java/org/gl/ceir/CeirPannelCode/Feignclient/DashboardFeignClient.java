...
public interface DashboardFeignClient {
	...
	public RequestCountAndQuantity consignmentNotification(@RequestParam(value = "userId") Integer userId,@RequestParam(value = "consignmentStatus") Integer consignmentStatus,@RequestParam(value = "userTypeId ") Integer userTypeId ) ;
