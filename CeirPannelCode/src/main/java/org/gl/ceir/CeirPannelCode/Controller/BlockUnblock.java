...
public class BlockUnblock {
	...
	public @ResponseBody GenricResponse blockSingleDevices(@RequestBody SingleImeiDetailsModel singleImeiDetailsModel,
			HttpSession session) {
	...
	public @ResponseBody GenricResponse UnblockSingleDevices(@RequestBody SingleImeiDetailsModel singleImeiDetailsModel,
			HttpSession session) {
		log.info("entry point in  save  single imei block");
		int userId = (int) session.getAttribute("userid");
		String roletype = session.getAttribute("usertype").toString();
	...
	public @ResponseBody GenricResponse updateBlockUnBlockSingleDevices(
			@RequestBody SingleImeiDetailsModel singleImeiDetailsModel, HttpSession session) {
...
//*************************************************** block bulk file ****************************************************************************
	...
	@RequestMapping(value = { "/reportblockBulkFile" }, method = {
	...
	public @ResponseBody GenricResponse FileTypeStolen(
			...
			@RequestParam(name = "blockCategory", required = false) Integer deviceCategory,
			@RequestParam(name = "remark", required = false) String remark, HttpSession session) {
...
//************************************************************ unblock bulk file ********************************************************************
	...
	@RequestMapping(value = { "/reportUnblockBulkFile" }, method = {
			org.springframework.web.bind.annotation.RequestMethod.GET,
			org.springframework.web.bind.annotation.RequestMethod.POST })
	...
	public @ResponseBody Object openBulkFile(@RequestParam(name = "reqType") Integer reqType,
			@RequestParam(name = "txnId", required = false) String txnId,
			@RequestParam(name = "singleDeivce", required = false) String singleDeivce, HttpSession session) {
...
//******************************************************* fetch singleImei details through txnId************************************************************		
	...
	@RequestMapping(value = "/openSingleImeiForm", method = {
			org.springframework.web.bind.annotation.RequestMethod.GET })
	public @ResponseBody List<SingleImeiDetailsModel> openSingleImeiForm(@RequestParam(name = "reqType") String reqType,
			@RequestParam(name = "txnId", required = false) String txnId,
			@RequestParam(name = "singleDeivce", required = false) String singleDeivce, HttpSession session) {
		log.info("entry point of  fetch block/unclock devices in the bases of transaction id .");
