...
public class operatorController {
	...
	@RequestMapping(value = { "/greyList" }, method = { org.springframework.web.bind.annotation.RequestMethod.GET,
	...
	@RequestMapping(value = { "/blackList" }, method = { org.springframework.web.bind.annotation.RequestMethod.GET,
			org.springframework.web.bind.annotation.RequestMethod.POST })
	...
	@RequestMapping(value = "/exportOperatorDetails", method = {
	...
	public String exportToExcel(@RequestParam(name = "startDate", required = false) String startDate,
		...
		log.info("startDate==" + startDate + " endDate =" + endDate + "userTypeId=" + userTypeId + "serviceDump="
				+ serviceDump + "fileType=" + fileType);
	...
	// ************************************************* download file
	// ***************************************************************
	@RequestMapping(value = "/dowloadFiles/{fileName}", method = {
			org.springframework.web.bind.annotation.RequestMethod.GET })
