...
public class SingleImeiDetails {
	...
	private Integer firstImei;
	private Integer fourthImei;
	private Integer id;
	...
	private Integer sarmId;
	private Integer secondImei;
	private Integer thirdImei;
	...
	public Integer getSarmId() {
		return sarmId;
	}

	public void setSarmId(Integer sarmId) {
		this.sarmId = sarmId;
	}
	...
	public String toString() {
		return "SingleImeiDetails [category=" + category + ", categoryInterp=" + categoryInterp + ", createdOn="
				+ createdOn + ", deviceIdType=" + deviceIdType + ", deviceIdTypeInterp=" + deviceIdTypeInterp
				+ ", deviceSerialNumber=" + deviceSerialNumber + ", deviceType=" + deviceType + ", deviceTypeInterp="
				+ deviceTypeInterp + ", firstImei=" + firstImei + ", fourthImei=" + fourthImei + ", id=" + id
				+ ", modifiedOn=" + modifiedOn + ", multipleSimStatus=" + multipleSimStatus
				+ ", multipleSimStatusInterp=" + multipleSimStatusInterp + ", processState=" + processState
				+ ", remark=" + remark + ", requestType=" + requestType + ", sarmId=" + sarmId + ", secondImei="
				+ secondImei + ", thirdImei=" + thirdImei + ", txnId=" + txnId + ", userId=" + userId + ", userType="
				+ userType + "]";
	}
