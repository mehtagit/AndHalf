...
public class SLAController {
	...
	@RequestMapping(value = { "/slaManagement" }, method = { org.springframework.web.bind.annotation.RequestMethod.GET,
	...
	public FileExportResponse exportToExcel(@RequestBody SLAfilterRequest filterRequest, HttpSession session) {
		...
		response = userProfileFeignImpl.viewSLARequest(filterRequest, filterRequest.getPageNo(),
