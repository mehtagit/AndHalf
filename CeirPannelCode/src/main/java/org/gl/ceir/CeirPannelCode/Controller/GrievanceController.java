...
public class GrievanceController {
	...
	@RequestMapping(value = { "grievanceManagement" }, method = {
	...
	public @ResponseBody GenricResponse saveGrievance(@RequestParam(name = "files[]") MultipartFile[] fileUpload,
		...
		for (MultipartFile file : fileUpload) {
			...
			try {
				...
				String rootPath = urlToUpload.getValue() + grevnceId + "/" + tagName + "/";
...
//***************************************** open save greivance *********************************
	@RequestMapping(value = "/openGrievanceForm", method = {
			org.springframework.web.bind.annotation.RequestMethod.GET })
	...
	public @ResponseBody List<GrievanceModel> viewGrievance(@RequestParam(name = "grievanceId") String grievanceId,
			HttpSession session, @RequestParam(name = "recordLimit") Integer recordLimit) {
	...
	// *********************************
	@RequestMapping(value = "/endUserViewGrievance", method = {
			org.springframework.web.bind.annotation.RequestMethod.GET })
	public @ResponseBody List<GrievanceModel> EndUserviewGrievance(
			@RequestParam(name = "grievanceId") String grievanceId, HttpSession session,
			@RequestParam(name = "recordLimit") Integer recordLimit, @RequestParam(name = "userId") Integer userId) {
	...
	// ***************************************** view Grievance controller
	// *********************************
	@RequestMapping(value = "/saveGrievanceMessage", method = {
			org.springframework.web.bind.annotation.RequestMethod.POST })
	public @ResponseBody GenricResponse saveGrievanceReply(@RequestParam(name = "files[]") MultipartFile[] fileUpload,
			HttpServletRequest request, HttpSession session) {

		// log.info("grievanceId=="+grievanceId+ " remark ="+remark+" txnId="+txnId+"
	...
	// ***************************************** view Grievance controller
	// *********************************
	@RequestMapping(value = "/saveEndUserGrievanceReply", method = {
			org.springframework.web.bind.annotation.RequestMethod.POST })
	public @ResponseBody GenricResponse saveEndUserGrievanceReply(
			@RequestParam(name = "files[]") MultipartFile[] fileUpload, HttpServletRequest request,
			HttpSession session) {
	...
	public String exportToExcel(@RequestParam(name = "grievanceStartDate", required = false) String grievanceStartDate,
			@RequestParam(name = "grievanceEndDate", required = false) String grievanceEndDate,
			@RequestParam(name = "grievancetxnId", required = false) String grievancetxnId,
			@RequestParam(name = "grievanceId") String grievanceId, HttpServletRequest request, HttpSession session,
			@RequestParam(name = "pageSize") Integer pageSize, @RequestParam(name = "pageNo") Integer pageNo,
			@RequestParam(name = "grievanceStatus") Integer grievanceStatus) {
		log.info("grievanceStartDate==" + grievanceStartDate + " grievanceEndDate =" + grievanceEndDate
				+ " grievancetxnId=" + grievancetxnId + "grievanceId=" + grievanceId);
		int userId = (int) session.getAttribute("userid");
		int file = 1;
	...
	@RequestMapping(value = { "/raiseAgrievance" }, method = {
			org.springframework.web.bind.annotation.RequestMethod.GET,
			org.springframework.web.bind.annotation.RequestMethod.POST })
	...
	public @ResponseBody GenricResponse saveEndUserGrievance(@RequestParam(name = "files[]") MultipartFile[] fileUpload,
			HttpServletRequest request, HttpSession session) {
	...
	// *********************************
	@RequestMapping(value = "/searchUserNameForm", method = {
			org.springframework.web.bind.annotation.RequestMethod.GET })
	...
	@RequestMapping(value = { "/raiseCCgrievance" }, method = {
			org.springframework.web.bind.annotation.RequestMethod.GET,
			org.springframework.web.bind.annotation.RequestMethod.POST })
