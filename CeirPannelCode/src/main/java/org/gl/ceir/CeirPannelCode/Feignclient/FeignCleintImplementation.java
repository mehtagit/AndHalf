...
public interface FeignCleintImplementation {
	...
	public @ResponseBody FileExportResponse downloadFile(@RequestParam("txnId") String txnId,
	...
	public List<Dropdown> consignmentStatusList(@PathVariable("featureId") Integer featureId,
	...
	public Object dashBoardNotification(@RequestBody FilterRequest filterRequest, @RequestParam Integer pageNo,
			@RequestParam Integer pageSize);

	// ***************************************************Admin Registration as Type
	// Dropdown********************************
...
//************************************************ view icon Message Management Feign *****************************************
	...
	public List<ActionModel> tableActionFeign(@PathVariable("featureId") Integer featureId,
			@PathVariable("userTypeId") Integer userTypeId);
