...
public class IconsState {
	...
	public String state(String fileName, String txnId, String status, String userStatus) {
		...
		/*
		 * String downloadURL = "./dowloadFiles/actual/"+fileName.replace(" ",
		 * "%20")+"/"+txnId+"/"+defaultTagName+"";
		 */
		// String errorURL = "./dowloadFiles/error/"+fileName.replace(" ",
		// "%20")+"/"+txnId+"/"+defaultTagName+"";
		String errorURL = "consignmentFileDownload('" + fileName.replace(" ", "%20") + "','error','" + txnId + "','"
				+ defaultTagName + "')";
		String downloadURL = "consignmentFileDownload('" + fileName.replace(" ", "%20") + "','actual','" + txnId + "','"
				+ defaultTagName + "')";
		...
		String delete = "<a onclick=" + deleteAction + " class=\"waves-effect waves-light modal-trigger\"><i class="
				+ deletionIcon + " aria-hidden=\"true\"  title=" + deleteIconTitle + "></i></a>";
		String reply = "<a href=" + emptyURL + " class=\"waves-effect waves-light modal-trigger\"><i class="
				+ deletionIcon + " aria-hidden=\"true\"  title=" + replyIconTitle + "></i></a>";

		String history = "<a onclick=" + historyAction + " class=\"waves-effect waves-light modal-trigger\"><i class="
				+ historyIcon + " aria-hidden=\"true\"  title=" + historyTitle + "></i></a>";
		log.info("status is @@@@@@@@-----1-----" + status);

		if (("0".equals(status)) && "Approved".equals(userStatus)) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i  class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + "  ></i></a>";
		}

		else if (("1".equals(status)) && "Approved".equals(userStatus)) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i  class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + "  ></i></a>";
			edit = "<a onclick=" + editAction + " class=" + disableIconClass + "><i class=" + disableEditIcon
					+ " aria-hidden=\"true\"  title=" + editIconTitle + "></i></a>";
			delete = "<a onclick=" + deleteAction
					+ " class=\"waves-effect waves-light modal-trigger eventNone\"><i class=" + disableDeletionIcon
					+ " aria-hidden=\"true\" title=" + deleteIconTitle + "></i></a>";
		} else if (("3".equals(status) || "5".equals(status) || "6".equals(status) || "8".equals(status)
				|| "9".equals(status)) && "Approved".equals(userStatus)) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i  class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + "  ></i></a>";
			edit = "<a onclick=" + editAction + " class=" + disableIconClass + "><i class=" + disableEditIcon
					+ " aria-hidden=\"true\" title=" + editIconTitle + "></i></a>";
			...
			error = "<a onclick=" + errorURL + "><i class=" + errorIcon + " aria-hidden=\"true\" title="
					+ errorIconTitle + "></i></a>";
			download = "<a onclick=" + downloadURL + " ><i class=" + downloadIcon + " aria-hidden=\"true\" title="
					+ downloadIconTitle + " ></i></a>";
			view = "<a onclick=" + viewAction + "><i class=" + viewIcon + " aria-hidden=\"true\" title=" + viewIconTitle
					+ " ></i></a>";
			...
			delete = "<a onclick=" + deleteAction + " class=\"waves-effect waves-light modal-trigger\"><i class="
					+ deletionIcon + " aria-hidden=\"true\"  title=" + deleteIconTitle + "></i></a>";
			reply = "<a href=" + emptyURL + " class=\"waves-effect waves-light modal-trigger\"><i class=" + deletionIcon
					+ " aria-hidden=\"true\"  title=" + replyIconTitle + "></i></a>";
		} else if (status != "0" || status != "1" || status != "2" || status != "3" || status != "4" || status != "5"
				|| status != "6" || status != "7" || status != "8" || status != "9" || status != "10" || status == null
				|| status.equals("")) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
			download = "<a onclick=" + downloadURL + "  class=" + disableIconClass + "><i class=" + disableDownloadIcon
			...
			delete = "<a onclick=" + deleteAction
					+ " class=\"waves-effect waves-light modal-trigger eventNone\" ><i class=" + disableDeletionIcon
					+ " aria-hidden=\"true\" title=" + deleteIconTitle + "></i></a>";
			view = "<a onclick=" + viewAction + " class=" + disableIconClass + "><i class=" + disableViewIcon
					+ " aria-hidden=\"true\" title=" + viewIconTitle + " ></i></a>";
			history = "<a onclick=" + historyAction + " class=" + disableIconClass + "><i class=" + disableHistoryIcon
					+ " aria-hidden=\"true\"  title=" + historyTitle + "></i></a>";
	...
	public String stockState(String fileName, String txnId, String status, String userStatus) {
		...
		executePostConstruct();
		String emptyURL = "JavaScript:void(0);";
		// String downloadURL = "./Consignment/dowloadFiles/actual/"+fileName.replace("
		// ", "%20")+"/"+txnId+"/"+defaultTagName+"";
		String downloadURL = "fileDownload('" + fileName.replace(" ", "%20") + "','actual','" + txnId + "','"
				+ defaultTagName + "')";
		String errorURL = "fileDownload('" + fileName.replace(" ", "%20") + "','error','" + txnId + "','"
				+ defaultTagName + "')";
		// String errorURL = "./Consignment/dowloadFiles/error/"+fileName.replace(" ",
		// "%20")+"/"+txnId+"/"+defaultTagName+"";
		...
		if (("0".equals(status)) && "Approved".equals(userStatus)) {
		...
		else if (("8".equals(status) || "4".equals(status) || "6".equals(status) || "1".equals(status))
				&& "Approved".equals(userStatus)) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i  class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + "  ></i></a>";
			edit = "<a onclick=" + editAction + " class=" + disableIconClass + "><i class=" + disableEditIcon
					+ " aria-hidden=\"true\" title=" + editIconTitle + "></i></a>";
			...
			view = "<a onclick=" + viewAction + "><i class=" + viewIcon + " aria-hidden=\"true\" title=" + viewIconTitle
					+ " ></i></a>";
			edit = "<a onclick=" + editAction + "><i class=" + editIcon + " aria-hidden=\"true\" title=" + editIconTitle
					+ "></i></a>";
			delete = "<a onclick=" + deleteAction + " class=\"waves-effect waves-light modal-trigger\"><i class="
					+ deletionIcon + " aria-hidden=\"true\"  title=" + deleteIconTitle + "></i></a>";
			reply = "<a href=" + emptyURL + " class=\"waves-effect waves-light modal-trigger\"><i class=" + deletionIcon
					+ " aria-hidden=\"true\"  title=" + replyIconTitle + "></i></a>";
			history = "<a onclick=" + historyAction + " class=\"waves-effect waves-light modal-trigger\"><i class="
					+ historyIcon + " aria-hidden=\"true\"  title=" + historyTitle + "></i></a>";
		} else if (status != "0" || status != "1" || status != "6" || status != "4" || status != "8" || status != "3"
				|| status != "7" || status == null || status.equals("")) {
			download = "<a onclick=" + downloadURL + "  class=" + disableIconClass + "><i class=" + disableDownloadIcon
					+ " aria-hidden=\"true\"  title=" + downloadIconTitle + " ></i></a>";
			view = "<a onclick=" + viewAction + " class=" + disableIconClass + "><i class=" + disableViewIcon
					+ " aria-hidden=\"true\" title=" + viewIconTitle + " ></i></a>";
	...
	public String customStockState(String fileName, String txnId, String status, String userStatus) {
		...
		if (("1".equals(status) || "3".equals(status) || "10".equals(status) || "6".equals(status))
				&& "Approved".equals(userStatus)) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i  class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + "  ></i></a>";
			edit = "<a onclick=" + editAction + " class=" + disableIconClass + "><i class=" + disableEditIcon
		...
		} else if (status != "1" || status != "3" || status != "10" || status != "6" || status != "0" || status != "2"
				|| status != "7" || status != "4" || status != "8" || status == null || status.equals("")) {
			download = "<a onclick=" + downloadURL + "  class=" + disableIconClass + "><i class=" + disableDownloadIcon
					+ " aria-hidden=\"true\"  title=" + downloadIconTitle + " ></i></a>";
			view = "<a onclick=" + viewAction + " class=" + disableIconClass + "><i class=" + disableViewIcon
					+ " aria-hidden=\"true\" title=" + viewIconTitle + " ></i></a>";
	...
	public String stolenState(String fileName, String txnId, String status, String userStatus, String requestType,
			int id, Integer qty) {
		executePostConstruct();
		// URL link
		...
		// String errorURL =
		// "./Consignment/dowloadFiles/error/"+file+"/"+txnId+"/"+defaultTagName+"";
		// String downloadURL =
		// "./Consignment/dowloadFiles/actual/"+file+"/"+txnId+"/"+defaultTagName+"";
	...
	public String customState(String fileName, String txnId, String status, String userStatus, String displayName) {
		...
		if ("6".equals(status) && "Approved".equals(userStatus)) {
			approve = "<a onclick=" + approveAction + " class=" + disableIconClass + "><i class=" + disableApproveIcon
					+ " aria-hidden=\"true\" title=" + approveIconTitle + " ></i></a>";
		} else if ("7".equals(status) && "Approved".equals(userStatus)) {
			reject = "<a onclick=" + rejectAction + " class=" + disableIconClass + "><i class=" + disableRejectIcon
		...
		} else if (status != "5" || status != "6" || status != "7" || status == null || status.equals("")) {
			download = "<a onclick=" + downloadURL + "  class=" + disableIconClass + "><i class=" + disableDownloadIcon
					+ " aria-hidden=\"true\"  title=" + downloadIconTitle + " ></i></a>";
			...
			reject = "<a onclick=" + rejectAction + " class=\"eventNone\"><i class=" + disableRejectIcon
					+ " aria-hidden=\"true\" title=" + rejectIconTitle + " ></i></a>";
			download = "<a onclick=" + downloadURL + "  class=" + disableIconClass + "><i class=" + downloadIcon
					+ " aria-hidden=\"true\"  title=" + downloadIconTitle + " ></i></a>";
	...
	public String adminState(String fileName, String txnId, String status, String userStatus, String companyName) {
		...
		if (("3".equals(status)) && "Approved".equals(userStatus)) {
			error = "<a onclick=" + errorURL + " class=\"eventNone\"><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
			...
			reject = "<a onclick=" + rejectAction + " class=\"eventNone\"><i class=" + disableRejectIcon
					+ " aria-hidden=\"true\" title=" + rejectIconTitle + " ></i></a>";
			delete = "<a onclick=" + deleteAction + " class=\"eventNone\"><i class=" + disableDeletionIcon
					+ " aria-hidden=\"true\" title=" + deleteIconTitle + "></i></a>";
		} else if (("7".equals(status)) && "Approved".equals(userStatus)) {
			approve = "<a onclick=" + approveAction + " class=\"eventNone\"><i class=" + disableApproveIcon
					+ " aria-hidden=\"true\" title=" + approveIconTitle + " ></i></a>";
			...
			error = "<a onclick=" + errorURL + " class=\"eventNone\"><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
			download = "<a onclick=" + downloadURL + "  class=\"eventNone\"><i class=" + disableDownloadIcon
					+ " aria-hidden=\"true\"  title=" + downloadIconTitle + " ></i></a>";
			approve = "<a onclick=" + approveAction + " class=\"eventNone\"><i class=" + disableApproveIcon
					+ " aria-hidden=\"true\" title=" + approveIconTitle + " ></i></a>";
			reject = "<a onclick=" + rejectAction + " class=\"eventNone\"><i class=" + disableRejectIcon
	...
	public String grievanceState(String fileName, String txnId, String grievanceId, String status, String userStatus,
			int userId) {
		executePostConstruct();
		...
		if (("0".equals(status) || "1".equals(status) || "2".equals(status)) && "Approved".equals(userStatus)) {
			...
			reply = "<a onclick=" + replyAction + " class=\"eventNone\"><i class=" + disableReplyIcon
					+ " aria-hidden=\"true\" title=" + replyIconTitle + " ></i></a>";
	...
	public String customGrievanceState(String fileName, String txnId, String grievanceId, String status,
			String userStatus, int userId) {
		executePostConstruct();
		String replyAction = "grievanceReply('" + userId + "','" + grievanceId + "','" + txnId + "')";
	...
	public String adminGrievanceState(String fileName, String txnId, String grievanceId, String status,
			String userStatus, int userId) {
		executePostConstruct();
		String replyAction = "grievanceReply('" + userId + "','" + grievanceId + "','" + txnId + "')";
		String viewAction = "viewGrievanceHistory('" + grievanceId + "')";
		...
		if (("0".equals(status) || "1".equals(status) || "2".equals(status)) && "Approved".equals(userStatus)) {
			...
			reply = "<a onclick=" + replyAction + " class=\"eventNone\"><i class=" + disableReplyIcon
					+ " aria-hidden=\"true\" title=" + replyIconTitle + " ></i></a>";
		} else if (status != "0" || status != "1" || status != "2" || status != "3" || status == null
				|| status.equals("")) {
			reply = "<a onclick=" + replyAction + " class=\"eventNone\"><i class=" + disableReplyIcon
					+ " aria-hidden=\"true\" title=" + replyIconTitle + " ></i></a>";
			view = "<a onclick=" + viewAction + " class=" + disableIconClass + "><i class=" + disableViewIcon
	...
	public String adminStockState(String fileName, String txnId, String status, String userStatus) {
		...
		if (("1".equals(status) || "8".equals(status)) && "Approved".equals(userStatus)) {
			...
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i  class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + "  ></i></a>";
		} else if (status != "1" || status != "8" || status != "7" || status != "5" || status != "9" || status != "6"
				|| status != "3" || status == null || status.equals("")) {
			view = "<a onclick=" + viewAction + " class=" + disableIconClass + "><i class=" + disableViewIcon
					+ " aria-hidden=\"true\" title=" + viewIconTitle + " ></i></a>";
			history = "<a onclick=" + historyAction + " class=" + disableIconClass + "><i class=" + disableHistoryIcon
					+ " aria-hidden=\"true\"  title=" + historyTitle + "></i></a>";
	...
	public String adminRegistrationRequest(String Id, String userStatus, String AdminCurrentStatus, String createdOn,
			String roles, String type, String id, String username, String status, String sessionUserName,
			String userTypeId) {
		executePostConstruct();
		log.info("username-->" + username + " sessionUserName--->" + sessionUserName);
		// URL link
		String emptyURL = "JavaScript:void(0);";
		String approveAction = "userApprovalPopup(" + Id + ",'" + createdOn.replace(" ", "=") + "','" + username + "','"
				+ sessionUserName + "')";
		...
		String view = "<a href=" + viewAction + "><i class=" + viewIcon + " aria-hidden=\"true\" title=" + viewIconTitle
				+ " ></i></a>";
	...
	public String userPaidStatusIcon(String imei1, String taxStatus, String status, String userStatus, String txnId) {
		...
		String taxPaid = "<a onclick=" + payTaxAction + "><i class=" + payTaxIcon + " aria-hidden=\"true\" title="
				+ payTaxIconTitle + "></i></a>";
		String view = "<a onclick=" + viewAction + "><i class=" + viewIcon + " aria-hidden=\"true\" title="
				+ viewIconTitle + " ></i></a>";
		String error = "<a onclick=" + errorURL + "><i class=" + errorIcon + " aria-hidden=\"true\" title="
				+ errorIconTitle + "></i></a>";
		String delete = "<a onclick=" + deleteAction + "><i class=" + deletionIcon + " aria-hidden=\"true\" title="
				+ deleteIconTitle + "></i></a>";
		...
		if (("3".equals(status) || "6".equals(status) || "7".equals(status)) && "Approved".equals(userStatus)) {
			...
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i  class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + "  ></i></a>";
			taxPaid = "<a onclick=" + payTaxAction
					+ "  class=\"waves-effect waves-light modal-trigger eventNone\" ><i class=" + disablePayTaxIcon
					+ " aria-hidden=\"true\" title=" + payTaxIconTitle + "></i></a>";
			...
			taxPaid = "<a onclick=" + payTaxAction
				...
				|| status != "8" || status == null || status.equals("")) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
			delete = "<a onclick=" + deleteAction
					+ " class=\"waves-effect waves-light modal-trigger eventNone\" ><i class=" + disableDeletionIcon
	 ...
	 * Icons for AdminUPS
	 **********************************/
	public String adminUserPaidStatusIcon(String imei1, String createdOn, String txnId, String State,
			String userStatus) {
		executePostConstruct();
		String viewAction = "viewDetails('" + imei1 + "','" + txnId + "')";
		...
		if ("6".equals(State) && "Approved".equals(userStatus)) {
			...
			reject = "<a onclick=" + rejectAction + "><i class=" + rejectIcon + " aria-hidden=\"true\" title="
					+ rejectIconTitle + " ></i></a>";
			delete = "<a onclick=" + deleteAction + "><i class=" + deletionIcon + " aria-hidden=\"true\" title="
					+ deleteIconTitle + "></i></a>";
	...
	public String greyBlackIcon(String userStatus, String fileName) {
		...
		String download = "<a href=" + downloadURL + " ><i class=" + downloadIcon + " aria-hidden=\"true\" title="
				+ downloadIconTitle + " ></i></a>";

		if ("Disable".equals(userStatus)) {
			log.info("CURRENT USER CANN'T ACCESS BCOZ STATUS IS::::::" + userStatus);

			download = "<a href=" + downloadURL + "  class=" + disableIconClass + "><i class=" + disableDownloadIcon
					+ " aria-hidden=\"true\" title=" + downloadIconTitle + " ></i></a>";
		}
	...
	public String blockUnblockState(String fileName, String txnId, String status, String userStatus, String requestType,
			int id, Integer qty, String source) {
		executePostConstruct();
		// URL link
		String file = fileName == null ? null : fileName.replace(" ", "%20");
		...
		if ((status.equals("0")) && "Approved".equals(userStatus)) {
			...
			history = "<a onclick=" + historyAction + " class=" + disableIconClass + "><i class=" + disableHistoryIcon
					+ " aria-hidden=\"true\"  title=" + historyTitle + "></i></a>";
		} else if (status != "0" || status != "1" || status != "2" || status != "3" || status != "4" || status != "7"
	...
	public String trcAdminManageIcons(String status, Integer id, String txnId, String userStatus, String fileName) {
		...
		// String downloadURL = "./dowloadFiles/actual/"+fileName.replace(" ",
		// "%20")+"/"+txnId+"/"+defaultTagName+"";
		// String downloadURL = "fileDownload('"+fileName.replace(" ",
		// "%20")+"','actual','"+txnId+"','"+defaultTagName+"')";
		...
		if ("6".equals(status)) {
		...
		} else if (("0".equals(status) || "1".equals(status) || "4".equals(status) || "8".equals(status))
				&& "Approved".equals(userStatus)) {
			error = "<a onclick=" + errorURL + " class=\"eventNone\"><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
			approve = "<a onclick=" + approveAction + " class=\"eventNone\"><i class=" + disableApproveIcon
			...
			delete = "<a onclick=" + deleteAction
					+ " class=\"waves-effect waves-light modal-trigger eventNone\"><i class=" + disableDeletionIcon
					+ " aria-hidden=\"true\"  title=" + deleteIconTitle + "></i></a>";
		} else if (status != "0" || status != "1" || status != "2" || status != "3" || status != "4" || status != "6"
				|| status != "7" || status != "8" || status == null || status.equals("")) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
			delete = "<a onclick=" + deleteAction
					+ " class=\"waves-effect waves-light modal-trigger eventNone\" ><i class=" + disableDeletionIcon
	...
	public String adminBlockUnblock(String fileName, String txnId, String status, String userStatus, String requestType,
			int id, Integer qty, String source, String operator) {
		String file = fileName == null ? null : fileName.replace(" ", "%20");
		String viewAction = "";
		// String downloadURL = "./Consignment/dowloadFiles/actual/" + file + "/" +
		// txnId +"/"+defaultTagName+ "";
		String downloadURL = "fileDownload('" + file + "','actual','" + txnId + "','" + defaultTagName + "')";
		...
		log.info("source->" + source + "status-->" + status + " userStatus--->" + userStatus + "  operator-->"
				+ operator);
		...
		if (("0".equals(status) || "1".equals(status)) && "Approved".equals(userStatus)) {
			...
			error = "<a onclick=" + errorURL + " class=\"eventNone\"><i class=" + disableErrorIcon
				...
				|| status != "6" || status == null || status.equals("")) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
			download = "<a onclick=" + downloadURL + "  class=" + disableIconClass + "><i class=" + disableDownloadIcon
					+ " aria-hidden=\"true\"  title=" + downloadIconTitle + " ></i></a>";
	...
	public String StolenlawfulAgency(String fileName, String txnId, String status, String userStatus,
			String requestType, int id, Integer qty, String source, String requestTypeValue) {
		executePostConstruct();
		// URL link
		String file = fileName == null ? null : fileName.replace(" ", "%20");
		...
		if ((status.equals("0")) && "Approved".equals(userStatus)) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
		} else if ((status.equals("1") || status.equals("3") || status.equals("5") || status.equals("6")
				|| "7".equals(status)) && "Approved".equals(userStatus)) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
			edit = "<a onclick=" + editAction + " class=" + disableIconClass + "><i class=" + disableEditIcon
					+ " aria-hidden=\"true\"  title=" + editIconTitle + "></i></a>";
			...
			history = "<a onclick=" + historyAction + " class=" + disableIconClass + "><i class=" + disableHistoryIcon
				...
				|| status != "6" || status != "7" || status == null || status.equals("")) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
			download = "<a onclick=" + downloadURL + "  class=" + disableIconClass + "><i class=" + disableDownloadIcon
					+ " aria-hidden=\"true\"  title=" + downloadIconTitle + " ></i></a>";
	...
	public String importalTrcManageIcons(String status, Integer id, String txnId, String userStatus, String fileName) {
		...
		if (("7".equals(status)) && "Approved".equals(userStatus)) {
			...
			error = "<a onclick=" + errorURL + " class=\"eventNone\"><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
		} else if (("1".equals(status) || "3".equals(status) || "4".equals(status) || "6".equals(status)
				|| "8".equals(status)) && "Approved".equals(userStatus)) {
			edit = "<a onclick=" + editAction + " class=" + disableIconClass + "><i class=" + disableEditIcon
					+ " aria-hidden=\"true\"  title=" + editIconTitle + "></i></a>";
			delete = "<a onclick=" + deleteAction
					+ " class=\"waves-effect waves-light modal-trigger eventNone\"><i class=" + disableDeletionIcon
			...
			history = "<a onclick=" + historyAction + " class=\"waves-effect waves-light modal-trigger\"><i class="
					+ historyIcon + " aria-hidden=\"true\"  title=" + historyTitle + "></i></a>";
		} else if (status != "0" || status != "1" || status != "3" || status != "4" || status != "6" || status != "7"
				|| status == null || status.equals("")) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
			edit = "<a onclick=" + editAction + " class=" + disableIconClass + "><i class=" + disableEditIcon
	...
	public String deviceActivationIcon(String imei1, String createdOn, String txnId, String status, String userStatus) {
		...
		} else if (status != "1" || status != "2" || status != "3" || status != "4" || status != "10" || status == null
				|| status.equals("")) {
			error = "<a onclick=" + errorURL + " class=" + disableIconClass + "><i class=" + disableErrorIcon
					+ " aria-hidden=\"true\" title=" + errorIconTitle + " ></i></a>";
	...
	public String trcAdminIcons(String status, Integer id, String fileName, String txnId, String adminApproveStatus) {
		...
		if ("0".equals(adminApproveStatus)) {
			...
			reject = "<a onclick=" + rejectAction + " class=\"eventNone\"><i class=" + disableRejectIcon
					+ " aria-hidden=\"true\" title=" + rejectIconTitle + " ></i></a>";
			download = "<a href=" + downloadURL + " ><i class=" + downloadIcon + " aria-hidden=\"true\" title="
					+ downloadIconTitle + " ></i></a>";
		}
	...
	public String AdminStolenlawfulAgency(String fileName, String txnId, String status, String userStatus,
			String requestType, int id, Integer qty, String source, String requestTypeValue) {
		executePostConstruct();
		// URL link
		String file = fileName == null ? null : fileName.replace(" ", "%20");
		...
		// String
		// action=error.concat(download).concat(view).concat(edit).concat(delete);
		String action = error.concat(download).concat(view).concat(approve).concat(reject).concat(delete)
				.concat(history);
		return action;
	}
	...
	public String consignmentDRTState(String fileName, String txnId, String status, String userStatus,
		...
		else if (status != "6" || status != "7" || status != "9" || status == null || status.equals("")) {
			download = "<a onclick=" + downloadURL + "  class=" + disableIconClass + "><i class=" + disableDownloadIcon
					+ " aria-hidden=\"true\"  title=" + downloadIconTitle + " ></i></a>";
			approve = "<a onclick=" + approveAction + " class=\"eventNone\"><i class=" + disableApproveIcon
					+ " aria-hidden=\"true\" title=" + approveIconTitle + " ></i></a>";
	...
	public String customerCareGrievanceState(String fileName, String txnId, String grievanceId, String status,
			String userStatus, int userId) {
		executePostConstruct();
		String replyAction = "grievanceReply('" + userId + "','" + grievanceId + "','" + txnId + "')";
		String viewAction = "viewGrievanceHistory('" + grievanceId + "')";
