...
@Component
public class DefaultReportResponse {
	private List<SubstationDefaultResponseModel> content = null;
	...
	public String toString() {
		...
		builder.append("DefaultReportResponse [content=");
	...
	public List<SubstationDefaultResponseModel> getContent() {
		return content;
	}
	public void setContent(List<SubstationDefaultResponseModel> content) {
