...
@Component
@Entity
@Table(name = "cdr_file_delete_aud")
@Getter
@Setter
public class CDRFilesDeleteAud implements Serializable {
	...
	@Column(name = "FILE_DELETE_TIME")
	@JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm")
	@UpdateTimestamp
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	private LocalDateTime file_delete_time;
	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("CDRFilesDeleteAud [id=");
		builder.append(id);
