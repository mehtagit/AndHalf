...
public interface CDRFileRecordsService {
	...
	public Optional<List<CDRFileRecords>> findByOperatorAndSourceAndStatusSIG1AndCdrRecdServer(String operator,String source,String statusSig1,String cdrRecdServer);
	public Optional<List<CDRFileRecords>> findByOperatorAndSourceAndStatusSIG2AndCdrRecdServer(String operator,String source,String statusSig2,String cdrRecdServer);
