...
public class Util {
	...
	public void writeInFile(String fileName, String header, List<ErrorRecord> record, String nameFileLocation) {
		...
		try {
			...
			// Dump list into a file.
			for(ErrorRecord errorRecord : record) {
				fw.append(Separator.NEW_LINE);
				fw.append(errorRecord.getImeiEsnMeid())
					.append(Separator.COMMA)
					.append(errorRecord.getErrorCode())
					.append(Separator.COMMA)
