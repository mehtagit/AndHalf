...
//     }
    ...
    public CDRFilesDeleteAud(long id, String createdOn, String source, String operator, String fileName, String statusSIG1, String statusSIG2, String cdrRecdServer, String sig1Utime, String sig2Utime, String file_delete_time) {
        this.id = id;
        this.createdOn = createdOn;
        this.source = source;
        this.operator = operator;
    ...
    public String toString() {
        return "CDRFilesDeleteAud{" + "id=" + id + ", createdOn=" + createdOn + ", source=" + source + ", operator=" + operator + ", fileName=" + fileName + ", statusSIG1=" + statusSIG1 + ", statusSIG2=" + statusSIG2 + ", cdrRecdServer=" + cdrRecdServer + ", sig1Utime=" + sig1Utime + ", sig2Utime=" + sig2Utime + ", file_delete_time=" + file_delete_time + '}';
    }
